...
<body>
  ...
  <main>
    ...
    <section class="contadores" aria-label="Estadísticas de WeerTeck" data-aos="fade-up">
      ...
      <div class="contador">
        <div class="numero" data-numero="12">0</div>
    ...
    <section id="faq" data-aos="fade-up">
      ...
      <details>
        <summary>¿Cómo funcionan las torres inteligentes?</summary>
        <p>Detectan humo, temperatura y gases, y envían alertas automáticas por WhatsApp.</p>
      </details>
      <details>
        <summary>¿Quién puede solicitar una torre?</summary>
        <p>Cualquier municipio, organización o vecino interesado en la protección ambiental.</p>
      </details>
      <details>
        <summary>¿El sistema de rociado daña el ambiente?</summary>
        <p>No, usamos soluciones 100% biodegradables y seguras.</p>
      </details>
      <details>
        <summary>¿Ofrecen capacitación para brigadas?</summary>
        <p>Sí, acompañamos la instalación con talleres y soporte técnico.</p>
      </details>
    </section>
  ...
  <script>
    ...
    function animarContador(element, numeroFinal, duracion = 2000) {
      let start = 0;
      const stepTime = Math.max(30, Math.abs(Math.floor(duracion / numeroFinal)));
      const increment = 1;
